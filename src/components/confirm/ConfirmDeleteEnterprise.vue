...
<template>
  <q-card class="bg-grey-2 form-basic">
    <q-card-section class="q-pa-none">
      <TitlePage
        title="Confirmação de exclusão da organização"
        style="color: red"
      />
    </q-card-section>
    <q-card-section>
      <div class="text-subtitle2">
        Para confirmar a
        <span class="text-subtitle2 text-red">EXCLUSÃO DE SUA ORGANIZAÇÃO</span
        >, por favor, digite
        <span class="text-subtitle2 text-red">CONFIRMAR</span> no campo de
        texto. É importante destacar que, todos os dados vinculado a sua
        organização serão apagados.
      </div>
    </q-card-section>
